    ...
    return (
        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-600 mt-2">Here's an overview of your exam activity</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    <h3 className="text-sm font-semibold text-gray-600 uppercase">Assigned Exams</h3>
                    <p className="text-4xl font-bold text-indigo-600 mt-2">0</p>
                    <p className="text-sm text-gray-500 mt-1">Exams available</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
